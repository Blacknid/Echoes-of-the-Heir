...
public class WindField {
    ...
    private java.io.File windMapFile(String mapId) {
        // TMX files live at ceva/src/res/maps/<Name>.tmx; mapId is the lowercased stem.
        // We save next to them so they ship in the resources folder.
        String fileName = mapId + ".windmap";
        // Try the source tree first (running from project root or ceva/).
        String[] candidates = {
            "ceva/src/res/maps/" + fileName,

...
| Painted Edge (final) | +8 | 5 | The Gallery secret | All trials complete |
...
| Mana Crystal | +3 MP | Drops, chests |
| Elixir | Full HP + MP | Merchant (Act 3), rare drop |
| Memory Tonic | Reveals nearest uncollected fragment on minimap for 60s | Merchant (Act 2), rare |

---

## 8. Quest Design — Full Chain

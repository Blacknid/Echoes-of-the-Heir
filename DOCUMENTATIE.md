...
### 3.2 Stările jocului (Game States)
...
### 16.3 Randarea jucătorilor remote
...
Aceasta permite adăugarea de conținut nou (monștri, NPC-uri, misiuni) **fără modificări de cod Java**, reducând ciclul de iterație al design-ului.
